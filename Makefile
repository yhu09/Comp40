# Daniel Ryaboshapka and You Hu 
# Makefile for arith (Comp 40 Assignment 4)
# 
# Includes build rules for 40image and bitpack as well as testing.
#
#
...
test_mem1: memory.o test_mem1.o 
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)

test_um: memory.o register.o test_um.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)

um: memory.o register.o um.o bitpack.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
	
clean:
	rm -f test_mem1, test_um, *.o
